...
# reconstruct tournament structure, check past champions

57864 tournament needs to be dropped.
Then came Season 0 (57888). 76 teams, each 6 games.
Need to add scores (tie breakers).

This formed the basis for the super league: Top 8 players formed the Super Premier League.
Then came the championship, A and B. Each with 8 players. Each championship supplies 2 new players.
